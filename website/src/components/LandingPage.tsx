      ...
      <section className="relative z-10 px-4 sm:px-12 pb-24 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-[1fr_0.9fr]">
            ...
            <div className="relative mx-auto aspect-[3/4] w-full max-w-[140px] overflow-hidden rounded-[1.25rem] border-2 border-[#39FF14] bg-black shadow-[0_0_34px_rgba(57,255,20,0.26)] sm:max-w-[170px]">
              <img
