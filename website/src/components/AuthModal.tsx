...
type SignupStep = "form" | "verify" | "onboarding" | "redirect";
...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const handleSignUpSubmit = async (e: React.FormEvent) => {
    ...
    // Show onboarding immediately after email entry, before account creation
